...
from inventory.sbom import services
...
def test_full_pipeline_sequence_succeeds(settings: pytest.FixtureRequest, tmp_path: object) -> None:
    ...
    with (
        ...
        patch("inventory.analysis.services.vulnerability.scan", return_value={"summary": {}}),
        patch("inventory.analysis.services.license.classify", return_value={"summary": {}}),
        patch("inventory.analysis.services.versions.classify", return_value={"summary": {}}),
    ):
