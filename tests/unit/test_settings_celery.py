...
def test_local_celery_dir_is_under_base_dir() -> None:
    # BASE_DIR is the repository root (Story 21.1); the broker tree lives under it so the
    # path is repo-relative and OS-correct on Windows (no hardcoded /tmp).
