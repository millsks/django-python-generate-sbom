...
from inventory.common.storage import PublicEndpointS3Storage
...
def test_production_default_storage_is_public_endpoint_s3() -> None:
    assert production.STORAGES["default"]["BACKEND"] == "inventory.common.storage.PublicEndpointS3Storage"
